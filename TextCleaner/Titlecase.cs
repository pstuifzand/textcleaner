...
{
    public class Titlecase : Operation
    {
        public string Name => "Convert To Titlecase";
        public string[] ArgNames => new string[] { };

        public OperationResult Process(string text, string[] args)
        {
            return new OperationResult(CultureInfo.CurrentCulture.TextInfo.ToTitleCase(text));
        }
    }
}
